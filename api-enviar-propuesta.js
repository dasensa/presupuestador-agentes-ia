// api/enviar-propuesta.js - BACKEND (Node.js + Express + Resend)
// Despliega en Vercel o tu servidor
...
export default async function handler(req, res) {
  ...
  try {
    await resend.emails.send({
      from: 'propuestas@tudominio.com', // Configura tu dominio en Resend
      to: email,
...
// ================================================================
// ALTERNATIVA: Usar Nodemailer (sin Resend)
// Descomentar si prefieres usar tu propio SMTP
// ================================================================
/*
