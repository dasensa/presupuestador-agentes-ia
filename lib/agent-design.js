...
const SECTOR_DESIGNS = {
  ...
  Banca: { systems: ['Core bancario', 'CRM financiero', 'KYC/AML y fraude', 'Identidad y firma'], guardrail: 'Las operaciones financieras requieren autenticación reforzada, límites transaccionales y registro íntegro.' },
