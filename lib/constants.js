export const SITE = {
  ...
  description: 'Transformamos empresas con agentes IA especializados por sector. Analisis, sinergias y ROI garantizado.',
  url: 'https://agentia.vercel.app',
};

export const NAV_LINKS = [
  { href: '/', label: 'Inicio' },
  { href: '/servicios', label: 'Agentes' },
...
export const VALUE_PROPS = [
  ...
  },
  {
    ...
    description: 'Modelos de calculo probados que aseguran un retorno positivo desde el primer ano.',
  },
];
