export const SITE = {
  name: 'AgentIA',
  tagline: 'Plataforma de construcción de agentes de inteligencia artificial',
  description: 'Solicita un agente IA y genera automáticamente una primera versión segura, evaluable y adaptada a tu sector.',
  url: process.env.NEXT_PUBLIC_SITE_URL || 'https://presupuestador-agentes-ia.vercel.app',
};

export const NAV_LINKS = [
  { href: '/', label: 'Inicio' },
  { href: '/crear-agente', label: 'Crear agente' },
